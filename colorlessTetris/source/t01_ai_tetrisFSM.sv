...
module t01_ai_tetrisFSM (
    ...
    output logic [3:0][3:0] next_block_preview // Output next block preview colors
);
    ...
    assign next_block_preview = next_block_pattern; 
    ...
    //                 next_block_preview[row][col] = WHITE;
    //             end else begin
    ...
    always_comb begin
        ...
        //             final_display_color[row][col] = WHITE; //should be current_piece_color
        //         end else begin
        //             // final_display_color[row][col] = stored_array[row][col] ? color_array_reg[row][col] : BLACK;
        //             final_display_color[row][col] = stored_array[row][col] ? WHITE : BLACK;
