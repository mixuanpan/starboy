...
// module t01_ai_MMU_new ( //32x32 matrix multiplication unit
//   input logic clk,
//   input logic rst_n,
//   input logic start, 
...
//   layer_state_t c_layer_state, n_layer_state; 
...
//     if (!rst_n) begin
//       state <= IDLE;
//       c_layer_state <= LAYER0; 
//       mac_counter <= 6'b0;
//       bias_counter <= 6'b0;
//     end else begin
//       state <= next_state;
//       c_layer_state <= n_layer_state; 
//       case (state)
//         MAC_PHASE: begin
//           if (act_valid) begin
...
//         if (c_layer_state == LAYER3 && bias_counter == (max_outputs - 1)) begin  // Fixed: Use max_outputs
//           done <= 1'b1;
//         end
//       end
//     end
