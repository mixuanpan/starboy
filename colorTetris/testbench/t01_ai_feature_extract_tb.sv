...
module t01_ai_feature_extract_tb();
    ...
    task create_board();
        // This task will be called before manually setting next_board
        next_board = 200'b0;
    endtask
    
    // Alternative helper task with individual row inputs
    task set_board_row(input [4:0] row_num, input [9:0] row_data);
        next_board[row_num*10 +: 10] = row_data;
    endtask
    ...
    initial begin
        ...
        create_board();
        set_board_row(5'd0, 10'b1000000000);
        set_board_row(5'd1, 10'b0000000000);
        set_board_row(5'd2, 10'b1000000000);
        wait_for_extraction();
        verify_results(3'd0, 8'd1, 8'd0, 8'd3, "Single Hole");
        
        // Test 5: Bumpiness test - varying heights
        create_board();
        set_board_row(5'd0, 10'b1100000000);
        set_board_row(5'd1, 10'b0100000000);
        set_board_row(5'd2, 10'b0100000000);
        set_board_row(5'd3, 10'b0100000000);
        wait_for_extraction();
        ...
        create_board();
        set_board_row(5'd0, 10'b1111111111);  // Full line
        set_board_row(5'd1, 10'b1011111111);  // Hole in column 1
        set_board_row(5'd2, 10'b1111111111);  // Full line
        set_board_row(5'd3, 10'b1011111111);  // Full line except one hole
        set_board_row(5'd4, 10'b1111111110);  // Almost full line
        wait_for_extraction();
        ...
        create_board();
        set_board_row(5'd0, 10'b1111111111);  // Full line
        set_board_row(5'd1, 10'b1111111111);  // Full line
        set_board_row(5'd2, 10'b1111111111);  // Full line
        set_board_row(5'd3, 10'b1111111111);  // Full line
        wait_for_extraction();
        verify_results(3'd4, 8'd0, 8'd0, 8'd40, "Four Full Lines");
        
        // Test 8: Maximum holes scenario
        create_board();
        set_board_row(5'd0, 10'b1111111111);  // Bottom blocks
        set_board_row(5'd1, 10'b0000000000);  // All holes
        set_board_row(5'd2, 10'b0000000000);  // All holes
        set_board_row(5'd3, 10'b0000000000);  // All holes
        set_board_row(5'd4, 10'b1111111111);  // Top blocks
        wait_for_extraction();
